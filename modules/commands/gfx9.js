...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/online-thunder-text-effect-generator-1031.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
